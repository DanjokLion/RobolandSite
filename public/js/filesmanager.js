...
function getItem( path ) {
  let posting = $.post( '/admin/files/', { path: path }, ( response ) => { returnData( response, path ) }  );
}
...
function renameItem() {
  ...
  $( ".fm-blackout" ).hide();
  let posting = $.post( '/admin/files/rename', { new:  path + '/' + file, old: path + '/' + old, path }, ( response ) => { returnData( response, path ) }  );
...
function delItem() {
  ...
  $( ".fm-blackout" ).hide();
  let posting = $.post( '/admin/files/delete', { file: $( ".del-file" ).val(), path  }, ( response ) => { returnData( response, path ) }  );
  $( ".del-file" ).val( 'null' )
  $( ".del-path" ).val( 'null' )
}
...
function showImg( imgPath ) {
  $( ".zoom-block .big-image" ).attr( 'style', 'background-image: url("/uploads/images'+imgPath+'")' )
